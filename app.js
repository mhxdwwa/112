...
function selectPetForAdopt(petName,studentId,fromModal=false){selectedPetName=petName;const _cancelAction=fromModal?'(function(){var o=document.querySelector(\'#modalContainer .modal-overlay:last-child\');if(o)o.remove();})()':'closeModal()';showModal('起个昵称',`<input id="nicknameInput" value="${petName}" style="width:100%;padding:10px;border-radius:20px;">`,[{text:'取消',onclick:_cancelAction},{text:'确认领养',onclick:`confirmAdoptPet('${studentId}')`}]);}
