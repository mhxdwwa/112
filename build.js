...
async function main() {
  ...
  for (const dir of ['战斗兽宠文件夹', '战斗机器人', 'images', 'audio', 'jiangyaoji-audio', 'jiangyaoji-images', 'mengdaxia-audio', 'shendouluo-images', 'zhandouluo-images']) {
    try {
